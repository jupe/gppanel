...
class gpSizerWin
{
    ...
    public:
        ...
        operator wxWindow*(){ return m_window; }
...
class gpHorizontalWindows
{
    ...
    public:
        ...
        void Rewind(){ m_it = m_windowList.begin(); }
    ...
    public:
        ...
        void Realize()
        {
            ...
            for(it = m_windowList.begin(); it!= m_windowList.end(); it++)
            {
                ...
                {
                    //m_topSizer->Add( window, wxSizerFlags(1).Expand().Border(wxALL, 5) );
                    ...
                    button_box->Add( new wxButton( window, wxID_ANY, _T("Two buttons in a box") ), wxSizerFlags().Border(wxALL, 7));
                    button_box->Add( new wxButton( window, wxID_ANY, _T("(wxCENTER)") ), wxSizerFlags().Border(wxALL, 7));
                    newsizer->Add(button_box, wxSizerFlags().Center());*/
